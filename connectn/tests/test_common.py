import numpy as np
from agent0.connectn.common import BoardPiece


def test_initialize_game_state():
    from agent0.connectn.common import initialize_game_state
...
def test_pretty_print_board():
    from agent0.connectn.common import pretty_print_board
    from agent0.connectn.common import initialize_game_state
...
def test_apply_player_action():
    from agent0.connectn.common import apply_player_action
    from agent0.connectn.common import initialize_game_state
...
def test_string_to_board():
    from agent0.connectn.common import string_to_board
    from agent0.connectn.common import pretty_print_board
...
def test_connected_four():
    from agent0.connectn.common import connected_four
    from agent0.connectn.common import pretty_print_board
    from agent0.connectn.common import string_to_board
    from agent0.connectn.common import initialize_game_state
...
def test_check_end_state():
    from agent0.connectn.common import check_end_state
    from agent0.connectn.common import pretty_print_board
    from agent0.connectn.common import string_to_board
    from agent0.connectn.common import initialize_game_state
